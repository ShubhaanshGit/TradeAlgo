...
st.subtitle("Who said crypto doesn't make sense!")


# In[ ]:


algo_button = st.sidebar.button('Make Money')
...
if algo_button:
    ...
    'Choose a cryptocurrency ticker of your choice - ', symb
    )
    ...
    if button:
        prof_df = algo_trade_3(asset_amount, user_asset_input)
        beautifydf(prof_df)
